# Домашнее задание к занятию "`Работа с данными (DDL/DML)`" - `Алексеев Александр`
...
# then connect throught mysql cli to sakila database with user 'sys_temp'  
...
2. ER-diagramm can be viewed by mysql-workbench:  
``` bash
$ sudo snap install mysql-workbench-community
```
![sakila-workbench](02-img/12-02-mysql-task-1-workbench-sakila.png)  
